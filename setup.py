...
setup(
    ...
    long_description="""
        ...
        Brought up to date coding standards and python 3.5 at Breve4py3_.
        ...
        .. _`Breve4py3`: https://github.com/katakumpo/breve4py3
    """,
    author='Cliff Wells',
    ...
    install_requires=[],
    scripts=['tools/soup2breve', 'tools/html2breve',
             'tools/xsd2breve', 'tools/breve_server/breve_server'],
