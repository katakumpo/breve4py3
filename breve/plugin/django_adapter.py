...
class TemplateAdapter(object):
    ...
    django.templates.Template in the sense that the render (params)
    ...
    def render(self, params=None):
        ...
        if params == None:
            ...
            result = {}
            for d in [d for d in params].__reversed__():
                result.update(d)
            params = result
...
def render_to_response(template, params=None, **kwargs):
    t = loader.get_template(template)
    return HttpResponse(t.render(params), **kwargs)


def render_to_string(template, params=None):
    t = loader.get_template(template)
    return flatten_string(t.render(params))
